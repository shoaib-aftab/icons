...
const categories = {
  ...
  business: ['briefcase', 'shopping-cart', 'shopping-bag', 'credit-card', 'wallet', 'dollar-sign', 'rupee', 'euro', 'pound', 'yen', 'bitcoin', 'bank', 'building-columns', 'landmark', 'shop', 'store', 'truck', 'shipping', 'bar-chart', 'pie-chart', 'trending-up', 'trending-down', 'activity', 'percent', 'receipt', 'invoice', 'barcode', 'qr-code', 'calculator', 'printer', 'scissors', 'scale', 'badge-percent', 'trophy', 'gem'],
  ...
  devices: ['monitor', 'laptop', 'tablet', 'smartphone', 'mobile', 'watch', 'cpu', 'chip', 'memory', 'battery', 'battery-charging', 'wifi', 'wifi-off', 'bluetooth', 'cast', 'airplay', 'tv', 'radio', 'speaker-device', 'projector'],
